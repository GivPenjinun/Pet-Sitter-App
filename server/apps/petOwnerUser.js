  ...
  try {
    ...
    await prisma.petOwnerUser.create({
      data: {
        ...
        image_profile:
          "https://rghjchtpazithinxrxrx.supabase.co/storage/v1/object/public/default-image/user-profile.png",
      },
    });

    // Send an email with the verification link
    const verificationLink = `https://pet-sitter-app-server.vercel.app/petowneruser/verify?token=${verificationToken}`;
